...
## 📌 快速开始（每次开工先看这里，最后更新 2026-08-08 v2.4.9）

**当前状态**
- 网页（云托管）：线上已含全部 v2.4.x 功能，最新 **v2.4.9**（总览签到「@」改为显示备注 + 一次性数据清理，将 27 条历史签到中误存进商家字段的内容迁回备注）已上线
- 小程序：**v2.4.0 ~ v2.4.8 均已上传开发版，但从未发布**（线上仍是旧版）。最新待发布 = **v2.4.8**（v2.4.9 为纯网页端改动，小程序无需改动）
