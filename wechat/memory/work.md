...
## 📌 快速开始（每次开工先看这里，最后更新 2026-08-08 v2.4.10）

**当前状态**
- 网页（云托管）：线上已含全部 v2.4.x 功能，最新 **v2.4.10**（删除次卡时级联删除关联签到 + 确认框提示）已上线
- 小程序：**v2.4.0 ~ v2.4.10 均已上传开发版，但从未发布**（线上仍是旧版）。最新待发布 = **v2.4.10**（已含 v2.4.5~v2.4.9 全部修复）
- 待办（人工，无法脚本化）：微信公众平台 → 版本管理 → 选 **v2.4.10** 开发版 → 提交审核 → 审核通过后发布（wujie 微前端导致 CDP 无法脚本化提交）
