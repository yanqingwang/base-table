#!/usr/bin/env python3
"""
DocuSign Connect Webhook Receiver — DEV.
...
_db: TrackingDb = TrackingDb(get_tracking_db_path("dev"))
...
def webhook_receiver() -> Response:
    ...
    try:
        secret: str = get_hmac_secret("dev")
...
def main() -> None:
    ...
    _db.init_schema()
    log.info("Tracking database ready at %s", get_tracking_db_path("dev"))
